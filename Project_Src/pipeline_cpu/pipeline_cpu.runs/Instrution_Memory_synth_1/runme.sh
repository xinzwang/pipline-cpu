...
HD_PWD='D:/pipeline-cpu/Project_Src/pipeline_cpu/pipeline_cpu.runs/Instrution_Memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Instrution_Memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Instrution_Memory.tcl
